...
10) Navigate back to the backend directory by typing cd ../.. or by any other method you prefer.
11) You should still be able to see the name of your virtual environment in parentheses. Type pip install -r requirements.txt into the terminal to download all the requirements for the backend. This process may take some time.

12) Type python download_words.py to download word lists needed for the recommender system. This may take some time.
